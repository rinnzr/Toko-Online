...
<h2 align="center" style="margin:30px 0 35px">Product</h2>
    <form method="post" style="margin:30px 30px 10px" action="produk_.php" class="d-flex">
...
<div class="row">   
        ...
        ?>
            ...
            <div class="col-md-3">
                <div class="card mt-3" style="background-color:#C6ADC6; border-radius:30px" >
                    ...
                    <div class="card-body">
                        ...
                        <a href="beli.php?id_produk=<?=$dt_produk['id_produk']?>" class="btn-beli">Beli</a>
                    </div>
                </div>  
            </div>
        <?php
